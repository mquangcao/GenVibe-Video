  ...
  return (
    <aside className={`bg-slate-700 text-white p-4 space-y-6 transition-all duration-300 ease-in-out ${isOpen ? 'w-64' : 'w-20'}`}>
      ...
      <nav className="space-y-2">
        <a href="#" className="flex items-center space-x-2 p-2 rounded-md hover:bg-slate-600">
          <FaHome size={20} />
      ...
      <nav className="space-y-2">
        ...
        <a href="#" className={`flex items-center space-x-2 p-2 rounded-md ${isOpen ? 'bg-slate-600' : 'bg-slate-600 justify-center'}`}>
          <FaRobot size={20} />
