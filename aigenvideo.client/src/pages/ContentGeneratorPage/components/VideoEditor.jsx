...
const VideoEditor = ({
  ...
  return (
    <div className="flex h-full p-1 md:p-6 lg:p-8">
      {/* Left Panel: Settings */}
      <div className="w-full md:w-1/2 bg-slate-800 p-1 flex flex-col space-y-0 rounded-l-xl">
        ...
        <div className="flex items-center gap-5 bg-slate-800 rounded-xl mb-7 ">
          <button
            ...
            className={`text-xs font-medium text-white overflow-x-auto flex-shrink-0 rounded px-2 py-1 transition-all whitespace-nowrap ${
        ...
        {activeTab === 'reference' && (
          <div className="space-y-5 pr-2 mt-2 overflow-y-auto  ">
              ...
              <div className="space-y-3">
                ...
                {subtitleSettings.enabled && (
                  <>
                    ...
                    {/* Enhanced Preview subtitle styling */}
                      ...
                      <div className="flex justify-center">
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: `${subtitleSettings.backgroundColor}E6`, // Add some transparency
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div
                            ...
                            title={subtitleSettings.fontColor}
                          />
                          <span className="font-mono">{subtitleSettings.fontColor}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <div
                            ...
                            title={subtitleSettings.backgroundColor}
                          />
                          <span className="font-mono">{subtitleSettings.backgroundColor}</span>
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <div className="flex items-center gap-1">
                            <div
                              ...
                              style={{ backgroundColor: subtitleSettings.fontColor }}
                            />
                            <span className="font-mono text-xs">{subtitleSettings.fontColor}</span>
                          </div>
                          <span>/</span>
                          <div className="flex items-center gap-1">
                            <div
                              ...
                              style={{ backgroundColor: subtitleSettings.backgroundColor }}
                            />
                            <span className="font-mono text-xs">{subtitleSettings.backgroundColor}</span>
                          </div>
                        </div>
                      </>
                    )}
