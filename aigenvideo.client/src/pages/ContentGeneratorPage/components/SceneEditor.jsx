...
const SceneEditor = ({
    ...
    return (
      <div className="bg-white p-5 rounded-xl shadow-md border border-gray-200">
        <div className="flex justify-between items-start mb-3">
          <h4 className="text-md font-bold text-gray-900">Scene {index + 1}</h4>
          <div className="flex gap-2">
            <button
              onClick={handleMoveUp}
              disabled={index === 0}
              className="p-1 text-gray-500 hover:text-sky-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              title="Move up"
            >
              <FaArrowUp size={12} />
            </button>
            ...
            <button onClick={() => onEdit(index)} className="p-1 text-gray-500 hover:text-red-500 transition-colors" title="Edit scene">
              <FaEdit size={14} />
            </button>
            <button
        ...
        {scene.imageUrl ? (
          ...
          <div className="mb-4 p-4 border-2 border-dashed border-yellow-400 rounded-lg bg-yellow-50">
        ...
        {/* Image Prompt (Title) */}
        <div className="mb-4 bg-gray-50 p-4 rounded-lg border-l-4 border-sky-500">
          <div className="flex items-center gap-3 text-sky-600 mb-2">
            <FaImages size={12} />
            <h5 className="text-sm font-semibold">Image Prompt</h5>
          </div>
          <p className="text-gray-900 font-mono text-sm leading-relaxed">{scene.title}</p>
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-500">
          <div className="flex items-center gap-3 text-purple-600 mb-2">
            ...
            {subtitleSettings?.enabled && (
              <div className="flex items-center gap-1">
                <FaClosedCaptioning className="text-purple-600" size={12} title="Will be used as subtitles" />
                <div
                  className="w-3 h-3 rounded border border-purple-500"
          ...
          <p className="text-gray-900 font-mono text-sm leading-relaxed whitespace-pre-wrap">{scene.summary}</p>
        </div>
  ...
  // Editing mode
  return (
    <div className="bg-white p-5 rounded-xl shadow-lg border border-sky-400">
      <div className="flex justify-between items-center mb-4">
        <h4 className="text-md font-bold text-gray-900">Editing Scene {index + 1}</h4>
        <div className="flex gap-2">
          <button
            onClick={handleSave}
          ...
          <button onClick={onCancel} className="px-3 py-1 bg-gray-500 hover:bg-gray-600 text-white rounded text-sm flex items-center gap-1">
            <FaTimes size={12} />
            Cancel
          </button>
        </div>
      ...
      <div className="mb-4">
        ...
        {scene.imageUrl && (
          <img
            ...
            alt="Scene preview"
            crossOrigin="anonymous"
            className="w-full h-32 object-cover rounded-lg border border-gray-300 mb-2"
            onError={(e) => {
        ...
        {!scene.imageUrl && (
          <div className="w-full h-32 bg-gray-100 border-2 border-dashed border-gray-400 rounded-lg flex items-center justify-center mb-2">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm flex items-center gap-1 disabled:bg-gray-400"
          >
            <FaUpload size={12} />
          ...
          <button
            ...
            className="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded text-sm flex items-center gap-1 disabled:bg-gray-400"
          >
            <FaImages size={12} />
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          className="w-full p-3 bg-gray-50 text-gray-900 rounded-lg border border-gray-300 h-20 resize-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
      ...
      {/* Summary */}
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700 mb-2">Content (Audio & Subtitle Text)</label>
        <textarea
          value={editedScene.summary}
          onChange={(e) => setEditedScene((prev) => ({ ...prev, summary: e.target.value }))}
          className="w-full p-3 bg-gray-50 text-gray-900 rounded-lg border border-gray-300 h-24 resize-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
